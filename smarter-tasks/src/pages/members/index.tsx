  ...
  return (
    <>
      <div className="flex justify-between">
        ...
        <div className="w-1/2 text-black shadow-lg container bordered text-m border-purple-400 rounded w-auto items-center justify-center bg-cyan-200 hover:bg-cyan-400">
