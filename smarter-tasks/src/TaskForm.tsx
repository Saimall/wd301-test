    ...
    <form onSubmit={addTask}>
      <div className="grid md:grid-cols-4 md:gap-3">
        <div className="relative z-0 w-full mb-6 group">
          ...
          <label
            htmlFor="todoTitle"
            className="peer-focus:font-medium absolute font-bold text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0"
          >
            Todo Title
          </label>
        </div>
        ...
        <div className="relative z-0 w-full mb-6 group">
          ...
          <label
            ...
            className="peer-focus:font-medium absolute font-bold text-l text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0"
          >
            Todo Description
          </label>
        </div>
